...
class MedusaModelABC(nn.Module):
    ...
    def medusa_generate(
        ...
        for idx in range(max_steps):
            ...
            print("position_ids", medusa_buffers["medusa_position_ids"])
            print("retrieve_indices", medusa_buffers["retrieve_indices"])
            '''


            # MIDSTEP SWITCH --> CHOOSE N BASED ON "ENTROPY"
            n = 5
            ...
            # Mask retrieve_indices, candidates
            ...
            medusa_logits, logits, outputs = tree_decoding(
                self,
                tree_candidates, # masked
                past_key_values,
                medusa_buffers["medusa_position_ids"],
                input_ids,
                retrieve_indices,  # masked
            )
